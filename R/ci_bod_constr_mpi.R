...
ci_bod_constr_mpi <- function(x,indic_col,up_w,low_w,penalty="POS")
{
...
#       options(warn=-2)  
  ...
  r<-list(ci_bod_constr_est_mpi=soluz,
          ci_bod_constr_mpi_pen = soluzmpi,
          ci_bod_constr_mpi_weights = w, 
          ci_method="bod_constrained_mpi")
  r$call<-match.call()
  class(r)<-"CI"
  r
